...
const handlers = {
  ...
  "pokerplus-payment-webhook": () => require(path.join(handlersDir, "pokerplus-payment-webhook.js")),
  ...
  "raffle-tournament-push": () => require(path.join(handlersDir, "raffle-tournament-push.js")),
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (await require("../lib/app-user-blocks").rejectBlockedRequestIdentity(req, res)) return;
