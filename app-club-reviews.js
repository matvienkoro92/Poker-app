(function(){
  ...
  function renderList(){
    ...
    r.querySelectorAll('.review-topic').forEach(function(article,index){
      var topic=visibleRows[index];
      if(topic.unread){article.classList.add('review-topic--unread');var meta=article.querySelector('.review-topic__body small');if(meta)meta.innerHTML=esc(date(topic.updatedAt))+'<span class="review-topic__unread-badge">Есть новый комментарий</span>';}
