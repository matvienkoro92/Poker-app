(function(){
  ...
  document.addEventListener('click',function(e){var el=e.target.closest('[data-review-action]');if(!el||busy)return;var action=el.dataset.reviewAction,id=el.dataset.id;
    if(action==='emoji-toggle'){var picker=el.parentElement.querySelector('[data-review-emoji-picker]'),open=picker.hidden;picker.hidden=!open;el.setAttribute('aria-expanded',String(open));return;}
