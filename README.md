...
**Важно:** доступ в PWA по-прежнему только для id из **`poker_app:visitors`** (кто хотя бы раз заходил в приложение с этим Telegram-аккаунтом). Webhook лишь подставляет актуальный @username; не «открывает» клуб незнакомым пользователям бота.
