...
- **Проверка ручной отправки** — вызовите `/api/freeroll-reminder-send?when=10min&secret=ВАШ_СЕКРЕТ`
- Если подписчиков нет, нажмите в приложении «Напомнить за 10 минут» под тестовым пользователем.
