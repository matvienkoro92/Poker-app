...
test('club totals reconcile legacy records, comments-only users and duplicate SCAN entries',async()=>{
  ...
  assert.deepEqual(report.totals,{publicationBonus:40,commentBonus:0,spinBonus:50,bonusTotal:90,publications:4,comments:21,spinsEarned:4,extraSpinsEarned:1,spinsAvailable:3});
