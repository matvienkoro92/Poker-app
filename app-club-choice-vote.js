  ...
  function duelAchievement(candidate, displayNick) {
    ...
    if (normalizedNick === "покерманки") {
      return {
        ...
        description: "Рекорд июля: 39 топ-3, из которых 37 топ-3 и 14 побед — в Лиге 1. 18 июля выиграл два турнира в один день, включая Биг Босс на 101 784 ₽. За месяц получил 593 684 ₽."
      };
    }
