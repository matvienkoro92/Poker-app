...
const { fetchPlayerInfo, hasPokerPlusConfig, readBoundPokerPlusUserId, readPokerPlusProfile } = require("../pokerplus");
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const msg = e && e.message ? String(e.message) : "PokerPlus profile fetch failed";
