...
module.exports = async function handler(req, res) {
  ...
  if (unsubscribe) {
    const out = await redisPipeline([["SREM", RATING_SUBSCRIBERS_KEY, userId], ["HSET", BOT_UNSUBSCRIBED_AT_KEY, userId, String(Date.now())]]);
  ...
  const out = await redisPipeline([
    ["SADD", RATING_SUBSCRIBERS_KEY, userId],
