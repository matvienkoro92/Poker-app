...
async function handleStatus(req, res, auth) {
  ...
  try { lifetimePrizes = await require('../daily-poker-lifetime').lifetimePrizes(linkedAccountIds, {pipeline:redisPipeline,readGames:readDailyPokerGameRows,prizeTotals:dailyPokerPrizeTotals}); }
