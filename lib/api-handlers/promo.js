...
async function handleWinners(req, res) {
  ...
  if (!gameIds.length) {
    return res.status(200).json(dailyPokerWinnersPayload(meta, spinStatsWithTotal, { totalWinners: 0, totalPrizeRubles: 0, winners: [] }));
  }
  ...
  return res.status(200).json(dailyPokerWinnersPayload(meta, spinStatsWithTotal, {
    firstSpinAt,
    firstSpinDate,
