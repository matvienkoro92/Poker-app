...
const DAILY_POKER_WINNERS_CACHE_PREFIX = "poker_app:daily_poker_winners_cache:v2:";
...
async function handleWinners(req, res) {
  ...
  const totalBonusAwards = prizeRecipients.reduce((sum, winner) => sum + safeInteger(winner.winsCount), 0);
