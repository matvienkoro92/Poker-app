...
function pokerProfilePublicStatsFromCachedProfile(profile) {
  ...
  return {
    ...
    hands: pick("hands"),
    bb: pick("bb"),
    winnings: pickNonNegative("winnings"),
    ofcWinnings: pickNonNegative("ofcWinnings", "ofc_winnings"),
    mttRound: pick("mttRound", "mtt_round"),
    mttWinnings: pickNonNegative("mttWinnings", "mtt_winnings"),
    mttCount: pick("mttCount", "mtt_count"),
    mttItmCount: pick("mttItmCount", "mtt_itm_count"),
    mttFirstCount: pick("mttFirstCount", "mtt_1st_count"),
    sngRound: pick("sngRound", "sng_round"),
    sngWinnings: pickNonNegative("sngWinnings", "sng_winnings"),
    sngCount: pick("sngCount", "sng_count"),
    sngItmCount: pick("sngItmCount", "sng_itm_count"),
    sngFirstCount: pick("sngFirstCount", "sng_1st_count"),
  };
}
