...
/**
 * Смайлики → короткие яркие словесные эмоции (жёлтая пресса).
 * Составные эмодзи — отдельными ключами; длинные сначала при замене.
 */
var EMOJI_TO_YELLOW_PRESS_PHRASE = {
  "🤣": "Хохот до икоты!",
  "😂": "Слёзы от смеха льются ручьём!",
  "😭": "Душа изливается в слезах!",
  "😱": "Ужас и трепет!",
  "😨": "Дрожь по коже!",
  "😰": "Холодный пот на лбу!",
  "😡": "Ярость клокочет!",
  "🤬": "Словесный гром и молнии!",
  "😤": "Надутые ноздри — обида знатная!",
  "🥳": "Праздник в душе!",
  "🤩": "Глаза горят от восторга!",
  "😍": "Сердце тает!",
  "🥰": "Нежность переполняет!",
  "😘": "Воздушный поцелуй в кадр!",
  "😗": "Чмок в сторону читателя!",
  "😙": "Улыбка с поцелуем!",
  "😚": "Смущённый поцелуй!",
  "😋": "Слюнки текут от предвкушения!",
  "😛": "Язык показан — дерзость!",
  "😜": "Подмигивание с вызовом!",
  "🤪": "Безумие в глазах!",
  "😝": "Дразнилка во весь рот!",
  "🤑": "Жадность до фишек слышна!",
  "🤗": "Обнимашки через экран!",
  "🤭": "Смех сквозь ладонь!",
  "🤫": "Тсс… интрига!",
  "🤔": "Лоб в складках — дума жжёт!",
  "😐": "Каменное лицо!",
  "😑": "Пустота во взгляде!",
  "😶": "Рот на замке!",
  "😏": "Хитрая ухмылка!",
  "😒": "Презрение налицо!",
  "🙄": "Закатывание глаз — классика!",
  "😬": "Напряжённая улыбка!",
  "😮": "Рот от неожиданности!",
  "😯": "Остолбенение!",
  "😲": "Шок до мозга костей!",
  "😳": "Румянец стыда и удивления!",
  "🥺": "Мольба в глазах!",
  "😦": "Челюсть отвисла!",
  "😧": "Искажение от потрясения!",
  "😢": "Слезинка на реснице!",
  "😞": "Уныние давит!",
  "😓": "Капли пота от нервов!",
  "😩": "Изнеможение душевное!",
  "😫": "Стон без слов!",
  "🥱": "Зевок до ушей!",
  "😴": "Морфей уже близко!",
  "🤤": "Слюни от вожделения!",
  ...
  "🥴": "Голова кружится!",
  "😵": "Звёзды в глазах!",
  "🤯": "Мозг взорвался от новости!",
  "🤠": "Ковбойский задор!",
  "🥸": "Инкогнito подозрительно!",
  "😎": "Крутость зашкаливает!",
  "🤓": "Зануда с удовольствием!",
  "🧐": "Монокль — внимание к деталям!",
  "😕": "Сомнение грызёт!",
  "🙁": "Грусть на лице!",
  "☹️": "Недовольство в лоб!",
  "☹": "Недовольство в лоб!",
  "🙂": "Вежливая улыбка с ноткой льда!",
  "🙃": "Всё с ног на голову!",
  "😉": "Дерзкое подмигивание!",
  "😊": "Свет в глазах!",
  "😇": "Невинность нарасхват!",
  "😀": "Улыбка на весь разворот!",
  "😃": "Радость бьёт фонтаном!",
  "😄": "Смех до ушей!",
  "😁": "Оскал чистой радости!",
  "😆": "Хохот с прищуром!",
  "🤢": "Тошнота от происходящего!",
  "🤮": "Рвота эмоций!",
  "🤧": "Апчхи — нервы!",
  "🤒": "Лихорадка от страсти!",
  "🤕": "Битва за столом далась в нос!",
  "😷": "Маска — держим дистанцию!",
  "😈": "Бесёнок в душе!",
  "👿": "Дьяволёнок злится!",
  "💀": "Смерть от смеха!",
  "☠️": "Череп предупреждает!",
  "☠": "Череп предупреждает!",
  "💩": "Дерьмовый настрой!",
  "🤡": "Цирк ушёл в отрыв!",
  "👻": "Дух иронии бродит!",
  "👽": "Внеземной холодок!",
  "🤖": "Роботизированная сухость!",
  "👾": "Пиксельная злорадство!",
  "😺": "Кошачья радость!",
  "😸": "Кот хохочет!",
  "😹": "Котьи слёзы смеха!",
  "😻": "Кот влюблён!",
  ...
  "😿": "Кот плачет!",
  "😾": "Кот обижен!",
  "❤️‍🔥": "Сердце пылает страстью!",
  "❤‍🔥": "Сердце пылает страстью!",
  "❤️": "Сердце бьётся чаще!",
  "❤": "Сердце бьётся чаще!",
  "🧡": "Оранжевый заряд энергии!",
  "💛": "Солнечный заряд!",
  "💚": "Зелёная надежда!",
  "💙": "Лазурная нежность!",
  "💜": "Фиолетовый восторг!",
  "🖤": "Чёрное сердце — драма!",
  "🤍": "Белоснежная искренность!",
  "🤎": "Тёплый коричневый уют!",
  "💔": "Сердце вдребезги!",
  "💕": "Два сердца — романтика!",
  "💖": "Сердце искрится!",
  "💗": "Сердце растёт!",
  "💘": "Стрела в сердце!",
  "💝": "Подарок чувств!",
  "💞": "Вихрь любви!",
  "💓": "Пульс страсти!",
  "💯": "Сто из ста — без скидок!",
  "🔥": "Огонь в глазах!",
  "⭐": "Звезда на лбу!",
  "🌟": "Сияние победы!",
  "✨": "Искры восторга!",
  "⚡": "Удар молнии по нервам!",
  "💥": "Взрыв эмоций!",
  "🎉": "Фейерверк радости!",
  "🎊": "Конфетти в душе!",
  "👏": "Аплодисменты стоят!",
  "🙌": "Руки к небу!",
  "👍": "Большой палец — зачёт!",
  "👎": "Палец вниз — осуждение!",
  "👌": "Окей, всё чётко!",
  "🤌": "Итальянский жест — вау!",
  ...
  "🤛": "Удар слева!",
  "🤜": "Удар справа!",
  "🙏": "Мольба или благодарность!",
  "💪": "Мускулы готовы к бою!",
  "🦾": "Железная воля!",
  "👋": "Махание рукой!",
  "✋": "Стоп, хватит!",
  "🖐️": "Ладонь в эфир!",
  ...
  "🫡": "Салют уважения!",
  "🫢": "Рот прикрыт от шока!",
  "🫣": "Подглядываем исподлобья!",
  "🫤": "Рот кривой — сомнение!",
  "🃏": "Джокер в колоде!",
  "♠️": "Пики — холод расчёта!",
  "♥️": "Черви — страсть!",
  "♦️": "Бубны — блеск!",
  "♣️": "Трефы — хитрость!",
  "♠": "Пики — холод расчёта!",
  ...
  "💤": "Сон клонит!",
  "💨": "Смыло с ног!",
  "🤷": "Плечи вверх — кто знает!",
  "🤷‍♂️": "Мужское «не в курсе»!",
  "🤷‍♀️": "Женское «не в курсе»!",
  "🤦": "Лицо в ладонях!",
  "🤦‍♂️": "Мужской фейспалм!",
  "🤦‍♀️": "Женский фейспалм!",
  "👀": "Глаза вылезли!",
  ...
  "😮‍💨": "Выдох облегчения!",
  "😵‍💫": "Голова идёт кругом!",
  "🥲": "Слеза на счастливом лице!",
  "🫠": "Таю от стыда или жары!",
  "🤥": "Нос растёт — шутка!",
  "🤐": "Рот на замке!",
  "🤨": "Бровь недовольна!",
  "🫥": "Проявляюсь сквозь текст!",
  "🫨": "Трясёт от потрясения!",
};

function expandEmojisToYellowPressPhrases(str) {
  var s = String(str || "");
  if (!s) return s;
  var keys = Object.keys(EMOJI_TO_YELLOW_PRESS_PHRASE).sort(function (a, b) {
    return b.length - a.length;
  });
  for (var i = 0; i < keys.length; i++) {
    var em = keys[i];
    var ph = EMOJI_TO_YELLOW_PRESS_PHRASE[em];
    if (!em || ph == null) continue;
    s = s.replace(new RegExp(escapeRegExp(em), "g"), " " + ph + " ");
  }
  try {
    s = s.replace(/\p{Extended_Pictographic}/gu, function () {
      return " эмоции бьют через край! ";
    });
  } catch (ePic) {}
  return s
    .replace(/\uFE0F/g, "")
...
/** Жёлтая пресса: OpenAI-совместимый POST { base }/chat/completions */
function yellowPressFallback(text) {
  var core = String(text || "")
    .trim()
    .replace(/\s+/g, " ");
  if (!core) return core;
  var head = "СКАНДАЛ? НЕТ — ГОЛОС ЧИТАТЕЛЯ «ВЕСТНИКА»! ";
  var mid = "«" + core + "»";
  var suffix =
    " Столы «Два туза» держат марку: здесь ценят честный розыгрыш и каждого, кто сел играть вместе.";
  var total = head + mid + suffix;
  if (total.length > MAX_TEXT) {
    total = total.slice(0, MAX_TEXT - 1) + "…";
  }
  return total;
}

async function rewriteCommentYellowPress(originalText) {
  var expandedInput = expandEmojisToYellowPressPhrases(String(originalText || "").trim());
  var key =
    process.env.OPENAI_API_KEY ||
    process.env.GAZETTE_YELLOW_PRESS_OPENAI_KEY ||
    process.env.GAZETTE_COMMENT_OPENAI_KEY ||
    "";
  var base = (process.env.OPENAI_API_BASE || "https://api.openai.com/v1").replace(/\/$/, "");
  var model = process.env.GAZETTE_YELLOW_PRESS_MODEL || "gpt-4o-mini";
  if (!key) {
    return yellowPressFallback(expandedInput);
  }
  var system =
    "Ты редактор сенсационной жёлтой прессы для покерного клуба «Два туза», газета «Вестник». " +
    "Перефразируй комментарий читателя в яркой, вызывающей, таблоидной манере: короткие фразы, эмоции, восклицания, интрига — но НИКОГДА не искажай смысл, факты и позицию автора. " +
    "Не придумывай событий, имён и цифр. Не удаляй важные детали из исходного текста. " +
    "Если в тексте есть эмодзи или смайлики — каждый замени на короткую яркую словесную эмоцию в духе жёлтой прессы, соответствующую настроению смайлика; не оставляй голые символы эмодзи в ответе. " +
    "Вплети кратко (1–2 короткие вставки) позитивный контекст в адрес клуба: честная игра, уважение к игрокам, атмосфера «Два туза» — без натужной рекламы и без лозунгов. " +
    "Выведи только итоговый текст комментария (один или два абзаца), без заголовка, без пояснений и без префикса «Редакция».";
  ...
  try {
    ...
    var res = await fetch(base + "/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          { role: "user", content: expandedInput },
        ],
      }),
      signal: ctrl.signal,
    });
    ...
    out = expandEmojisToYellowPressPhrases(out);
    if (!out) {
      return yellowPressFallback(expandedInput);
    }
...
module.exports = async function handler(req, res) {
  ...
  var publishedText;
  try {
    publishedText = await rewriteCommentYellowPress(text);
  } catch (eRw) {
    publishedText = yellowPressFallback(text);
  }
  if (!publishedText || !String(publishedText).trim()) {
    publishedText = yellowPressFallback(text);
  }
  publishedText = String(publishedText).trim();
  if (publishedText.length > MAX_TEXT) {
    publishedText = publishedText.slice(0, MAX_TEXT);
  }
