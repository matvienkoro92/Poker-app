...
async function handleBonusIssueReview(req, res, auth, operationId) {
...
module.exports = async function handler(req, res) {
  ...
  if (req.method === "POST" && tail[0] === "bonus-issues" && tail[2] === "verify") return handleBonusIssueReview(req, res, auth, tail[1]);
