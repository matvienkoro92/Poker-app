...
async function buildRealPlayers(options = {}) {
  ...
  statsSummary.raffles = await optionalCrmStep("raffle-stats", {
    ...
    return { available: true, uniqueParticipants: participantKeys.size, uniqueWinners: winnerKeys.size, issuedPrizeAmount, issuedCashAmount, issuedTicketAmount, issuedRecipients, issuedByAdmin, issuedByAdminBreakdown };
  }, warnings);
