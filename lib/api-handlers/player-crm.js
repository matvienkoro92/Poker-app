...
async function buildRealPlayers(options = {}) {
  ...
  statsSummary.raffles = await optionalCrmStep("raffle-stats", {
    ...
    if (!ids.length) return { available: true, uniqueParticipants: 0, uniqueWinners: 0, issuedPrizeAmount: 0, issuedCashAmount: 0, returnedAmount: 0, returnCount: 0, issuedTicketAmount: 0 };
    ...
    return { available: true, uniqueParticipants: participantKeys.size, uniqueWinners: winnerKeys.size, issuedPrizeAmount, issuedCashAmount, returnedAmount, returnCount, issuedTicketAmount, issuedRecipients, recipientsPending: !includeRaffleRecipients, issuedByAdmin, issuedByAdminBreakdown };
  }, warnings);
