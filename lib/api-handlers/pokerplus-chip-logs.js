...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const adminLinkedMailSources = isReportAdmin && !envSources.length && !linkedCashierSources.length ? cashHistoryAdminLinkedMailSources(userAppId, mail, linkedSourceIds) : [];
