  ...
  if (req.method === "GET") {
    ...
    if (withId) {
      ...
      if (messagesBare && !wantsOlderDm && !canTryFastTailDm) {
        ...
        const bareRow = bareRes && bareRes[0] && Array.isArray(bareRes[0].result) ? bareRes[0].result : [];
      ...
      const [fastDtIds, fastNamesRes, fastDisplayByPeer, fastAvatars, fastP21Ids, fastVerified, fastStatusMeta] =
        fastIds.length > 0
          ? await Promise.all([
              ...
              getChatDisplayNameMapForIds(fastIds),
              getAvatars(fastIds),
              getP21Ids(fastIds),
              getPokerPlusVerifiedIds(fastIds),
              getPokerProfileStatusMeta(fastIds),
            ])
          : [{}, [], {}, {}, {}, {}, {}];
      const fastNamesRow =
        fastNamesRes && fastNamesRes[0] && Array.isArray(fastNamesRes[0].result) ? fastNamesRes[0].result : [];
