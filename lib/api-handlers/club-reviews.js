...
module.exports=async(req,res)=>{try{
  ...
  if(action==='list'||action==='summary')return res.status(200).json({ok:true,...await reviews.list(c,action==='summary'?'others':b.mine===true,b.cursor),activity:await activity.summary(c.accountId)});
