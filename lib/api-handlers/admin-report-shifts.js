...
module.exports = async function handler(req, res) {
  ...
  if (req.method === "POST") {
    ...
    if (action === "rakeback_draft_save") {
      ...
      return res.status(200).json({ ok: true, rakebackDraft: draft, reportSync });
    }
    ...
    const reportRows = normalizeRakebackRows(body.rakebackRows);
  ...
  if (req.method === "PUT") {
    ...
    const updatedRows = Array.isArray(body.rakebackRows) ? normalizeRakebackRows(body.rakebackRows) : (found.rakebackRows || []);
