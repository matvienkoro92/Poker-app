...
function normalizeRakebackRows(rows) {
  ...
  return rows
    .map((row) => {
      ...
      const entryAddedAt = normalizeRakebackRowTime(row.entryAddedAt || row.firstAddedAt || (hasEntryData ? row.addedAt : ""));
      ...
      return {
        ...
        createdAt,
        standardAt,
        entryAddedAt: entryAddedAt || (hasEntryData ? createdAt : ""),
        amount,
