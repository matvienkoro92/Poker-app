...
function rewardForHandRank(handRank, state) {
  ...
  if (rank === "four_of_a_kind") {
    return { type: "ticket", amount: 1200, title: "Билет на Нокаут Мистери 1 200 ₽", ticketAmount: 1200, bonusAmount: 0, grantsExtraAttempt: false };
  }
  if (rank === "full_house") {
    return { type: "ticket", amount: 500, title: "Билет на любой турнир за 500 ₽", ticketAmount: 500, bonusAmount: 0, grantsExtraAttempt: false };
  }
  if (rank === "flush") {
