...
local types = {DEL='any', HDEL='hash', HSETNX='hash', SET='string', HSET='hash', HINCRBY='hash', INCR='string', INCRBY='string', SADD='set', SREM='set', LPUSH='list', LTRIM='list', LREM='list'}
local numbers = {}
