 ...
 * Отладка: LOG_CHAT_DM_PUSH=1 — в лог пишется строка, если личный пуш не доставлен ни на одно устройство (0 подписок / VAPID / Redis / выкл. в профиле).
...
async function notifyChatDmWebPush({ recipientId, senderId, senderName, snippet }) {
  ...
  if (n === 0 && process.env.LOG_CHAT_DM_PUSH === "1") {
