...
async function readHero(accountId,privateView=true){const d=await load(accountId);return view(d.state,d.level,privateView);}
...
module.exports={fresh,parse,levelOf,stats,view,mutate,readHero,updateHero};
