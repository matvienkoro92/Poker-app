 ...
 *
 * Долгий TTL — как у Telegram PWA: выход только через «Выйти из профиля» на устройстве.
 */
const crypto = require("crypto");

const PWA_VK_PREFIX = "pwa_sess_vk_v1:";
/** ~10 лет */
const PWA_VK_SESSION_TTL_SECONDS = 60 * 60 * 24 * 365 * 10;
...
function signPwaVkSession(user, ttlSec) {
  ...
  const ttl = ttlSec != null ? ttlSec : PWA_VK_SESSION_TTL_SECONDS;
...
module.exports = { signPwaVkSession, verifyPwaVkSessionToken, vkSigningSecret, PWA_VK_SESSION_TTL_SECONDS };
