...
var WINTER_RATING_IMAGES = {
  ...
  // 28.02: [2] AMBER RUSH; [4] LUCKY 777 — -5.png
  ...
  // 10.02: 18:00 Фокс — -3.png (топ заносов ~8-я строка)
  ...
  // 31.01: 19:30, 18:00, 12:00, 00:00. -4.png при необходимости — скрин 00:00 (vnukshtukatura).
  ...
  // 11–10.01: имена -N.png не по времени; массив переупорядочен под WINTER_RATING_TOURNAMENTS_BY_DATE
...
var SPRING_RATING_UPDATED = "07.04.26";
