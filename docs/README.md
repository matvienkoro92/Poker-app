...
- `2026-05-03-ui-chat-product-worklog.md` - profile/home/download/chat/theme/rating product fixes through app version `2.695`, kept as historical work before later CRM/Poker21/admin/rating tracks.
