var POKER_PWA_AUTH_I18N = {
  auth: {
      ru: {
        ...
        emailNewAccountConfirm: "Создать отдельный новый профиль. Мой прежний профиль и его история сюда не перенесутся.",
        emailIntro1: "Уже входили через бота? Войдите через Telegram и привяжите почту в профиле — так сохранится ваша история.",
      ...
      en: {
        ...
        emailNewAccountConfirm: "Create a separate new profile. My existing profile and history will not be transferred.",
        emailIntro1: "Already used the bot? Sign in with Telegram and link your email in your profile to keep your history.",
  ...
  profile: {
      ru: {
        ...
        pokerPlusText: "Вставьте свой ключ из Poker21, чтобы привязать аккаунт. Ключ найдите по кнопке в клубе, указанной на картинке.",
      ...
      en: {
        ...
        pokerPlusText: "Paste your key from Poker21 to link your account. Find the key using the club button shown in the picture.",
  ...
  global: {
      ru: {
        ...
        learnDesc: "1 бесплатно · 17 за 3 000 ₽",
        streams: "Стримы",
        inDev: "(в разработке)",
